...
export const PERSONAL_INFO = {
  ...
  role: 'Officer (Software Development) • 7.2+ Yrs Experience',
  ...
  stats: [
    { label: 'Total Experience', value: '7.2 Years' },
    { label: 'Padma Bank PLC', value: '3.1 Years' },
...
export const EXPERIENCES: Experience[] = [
  {
    ...
    period: '03-09-2023 to Continue (3.1 Years)',
